...
An Elixir package for managing checks, schedules, contacts, etc. on your NodePing account. You can find your API key
...
def deps do
  [
    {:nodeping, git: "https://github.com/stratacast/nodeping_elixir", tag: "0.9.2"}
  ]
end
----
